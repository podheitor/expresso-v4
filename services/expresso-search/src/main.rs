...
async fn main() -> anyhow::Result<()> {
    ...
    let api_routes = Router::new()
        ...
        .route("/api/v1/search/index/segments/byte-density-p75",          get(api::segment_byte_density_p75))
        .route("/api/v1/search/index/segments/byte-density-p90",          get(api::segment_byte_density_p90))
        .route("/api/v1/search/index/segments/cv-bytes",                   get(api::segment_cv_bytes))
        .route("/api/v1/search/index/segments/cv-docs",                    get(api::segment_cv_docs))
        .route("/api/v1/search/index/segments/iqr-bytes",                  get(api::segment_iqr_bytes))
        .route("/api/v1/search/index/segments/iqr-docs",                   get(api::segment_iqr_docs))
        .route("/api/v1/search/index/segments/avg-docs",                   get(api::segment_avg_docs))
        .route("/api/v1/search/index/segments/stddev-bytes",               get(api::segment_stddev_bytes))
        .route("/api/v1/search/index/segments/stddev-docs",                get(api::segment_stddev_docs))
        .route("/api/v1/search/index/segments/count-empty",                get(api::segment_count_empty))
        .route("/api/v1/search/index/segments/docs-count-by-size-bucket",   get(api::segment_docs_count_by_size_bucket))
        .route("/api/v1/search/index/segments/size-bucket-distribution",   get(api::segment_size_bucket_distribution))
        .route("/api/v1/search/index/segments/doc-bucket-distribution",    get(api::segment_doc_bucket_distribution))
        .route("/api/v1/search/index/segments/avg-bytes",                  get(api::segment_avg_bytes))
        .route("/api/v1/search/index/segments/docs-density-p75",           get(api::segment_docs_density_p75))
        .route("/api/v1/search/index/segments/docs-density-p90",           get(api::segment_docs_density_p90))
        .route("/api/v1/search/index/segments/docs-density-min",           get(api::segment_docs_density_min))
        .route("/api/v1/search/index/segments/docs-density-max",           get(api::segment_docs_density_max))
        .route("/api/v1/search/index/segments/docs-density-range",        get(api::segment_docs_density_range))
        .route("/api/v1/search/index/segments/docs-density-cv",           get(api::segment_docs_density_cv))
        .route("/api/v1/search/index/segments/docs-density-iqr",          get(api::segment_docs_density_iqr))
        .route("/api/v1/search/index/segments/docs-density-p50",          get(api::segment_docs_density_p50))
        .route("/api/v1/search/index/segments/docs-density-avg",          get(api::segment_docs_density_avg))
        .route("/api/v1/search/index/segments/docs-density-stddev",       get(api::segment_docs_density_stddev))
        .route("/api/v1/search/index/segments/byte-density-cv",           get(api::segment_byte_density_cv))
        .route("/api/v1/search/index/segments/byte-density-iqr",          get(api::segment_byte_density_iqr))
        .route("/api/v1/search/index/segments/byte-density-range",        get(api::segment_byte_density_range))
        .route("/api/v1/search/index/segments/byte-density-p50",          get(api::segment_byte_density_p50))
        .route("/api/v1/search/index/segments/byte-density-avg",         get(api::segment_byte_density_avg))
        .route("/api/v1/search/index/segments/byte-density-max",          get(api::segment_byte_density_max))
        .route("/api/v1/search/index/segments/byte-density-min",          get(api::segment_byte_density_min))
        .route("/api/v1/search/index/segments/byte-density-stddev",       get(api::segment_byte_density_stddev))
        .route("/api/v1/search/index/segments/bytes-above-avg",          get(api::segment_bytes_above_avg))
        .route("/api/v1/search/index/segments/docs-above-avg",           get(api::segment_docs_above_avg))
        .route("/api/v1/search/index/segments/size-outliers",            get(api::segment_size_outliers))
        .route("/api/v1/search/index/segments/docs-outliers",            get(api::segment_docs_outliers))
        .route("/api/v1/search/index/segments/merge-candidates",         get(api::segment_merge_candidates))
        .route("/api/v1/search/index/segments/hot-ratio",               get(api::segment_hot_ratio))
        .route("/api/v1/search/index/segments/cold-ratio",              get(api::segment_cold_ratio))
        .route("/api/v1/search/index/segments/anomaly-score",           get(api::segment_anomaly_score))
