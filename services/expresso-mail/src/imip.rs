...
\r\nBEGIN:VCALENDAR\r\nMETHOD:REQUEST\r\nVERSION:2.0\r\nBEGIN:VEVENT\r\nUID:u1\r\nEND:VEVENT\r\nEND:VCALENDAR\r\n";
    ...
    #[test]
    fn has_method_reply_returns_false_for_cancel() {
        assert!(!has_method_reply("METHOD:CANCEL"));
    }
    ...
    #[test]
    fn has_method_reply_ignores_non_method_colon_prefix() {
        assert!(!has_method_reply("X-METHOD:REPLY"));
    ...
    #[test]
    fn has_method_reply_returns_false_for_add() {
        assert!(!has_method_reply("METHOD:ADD"));
    }
}
