...
**Último sprint commitado:** #527 (2026-05-03)
...
## Próximos candidatos (#528-#532)

1. **calendar:** exdates-preview rico — `?detail=full` em `/exdates-preview` (#525) e/ou `/exdates-preview/stats` (#526), paralelo direto do #527 mas pra EXDATE: `in_range`/`out_of_range` viram `[{raw_value, tzid, params, kind, parsed_utc}]` reusando `parse_exdates_rich` que já produz esse shape — UI pode mostrar "vai cancelar estas instâncias: TZID Europe/Berlin 20260510, 20260517..."
