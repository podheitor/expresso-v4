...
mod tests {
    ...
    #[test]
    fn snooze_record_december_snooze_until_preserved() {
        use time::macros::datetime;
        ...
        assert_eq!(r.snooze_until, target);
    }

    #[test]
    fn snooze_record_snoozed_at_preserved() {
        use time::macros::datetime;
    ...
    #[test]
    fn snooze_record_user_id_preserved() {
        use time::macros::datetime;
        let uid = Uuid::new_v4();
        let r = SnoozeRecord {
    ...
    #[test]
    fn snooze_record_tenant_id_preserved() {
        use time::macros::datetime;
        let tid = Uuid::new_v4();
        let r = SnoozeRecord {
