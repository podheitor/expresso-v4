...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/api/v1/drive/files/stats/deletes-by-ext",                   get(file_stats_deletes_by_ext))
        ...
        .route("/api/v1/drive/files/stats/deleted-by-ext",                   get(file_stats_deleted_by_ext))
        .route("/api/v1/drive/files/stats/deleted-by-owner",                 get(file_stats_deleted_by_owner))
        .route("/api/v1/drive/files/stats/active-count-total",               get(file_stats_active_count_total))
        .route("/api/v1/drive/files/stats/deleted-count-total",              get(file_stats_deleted_count_total))
        .route("/api/v1/drive/files/stats/size-total-active",                get(file_stats_size_total_active))
        ...
        .route("/api/v1/drive/files/stats/min-size-by-kind",                 get(file_stats_min_size_by_kind))
        .route("/api/v1/drive/files/stats/min-size-by-mime",                 get(file_stats_min_size_by_mime))
        .route("/api/v1/drive/files/stats/min-size-by-ext",                  get(file_stats_min_size_by_ext))
        .route("/api/v1/drive/files/stats/min-size-by-owner",                get(file_stats_min_size_by_owner))
        .route("/api/v1/drive/files/stats/std-dev-size-by-kind",              get(file_stats_std_dev_size_by_kind))
        .route("/api/v1/drive/files/stats/std-dev-size-by-mime",              get(file_stats_std_dev_size_by_mime))
        .route("/api/v1/drive/files/stats/std-dev-size-by-ext",               get(file_stats_std_dev_size_by_ext))
        .route("/api/v1/drive/files/stats/std-dev-size-by-owner",             get(file_stats_std_dev_size_by_owner))
        .route("/api/v1/drive/files/stats/var-size-by-kind",                  get(file_stats_var_size_by_kind))
        .route("/api/v1/drive/files/stats/var-size-by-mime",                  get(file_stats_var_size_by_mime))
        .route("/api/v1/drive/files/stats/var-size-by-ext",                   get(file_stats_var_size_by_ext))
        .route("/api/v1/drive/files/stats/var-size-by-owner",                 get(file_stats_var_size_by_owner))
        .route("/api/v1/drive/files/stats/name-length-var-by-kind",           get(file_stats_name_length_var_by_kind))
        .route("/api/v1/drive/files/stats/name-length-var-by-mime",           get(file_stats_name_length_var_by_mime))
        .route("/api/v1/drive/files/stats/name-length-var-by-ext",            get(file_stats_name_length_var_by_ext))
        .route("/api/v1/drive/files/stats/name-length-var-by-owner",          get(file_stats_name_length_var_by_owner))
        .route("/api/v1/drive/files/stats/name-length-skewness-by-kind",      get(file_stats_name_length_skewness_by_kind))
        .route("/api/v1/drive/files/stats/name-length-kurtosis-by-kind",      get(file_stats_name_length_kurtosis_by_kind))
        .route("/api/v1/drive/files/stats/name-length-p25-by-kind",           get(file_stats_name_length_p25_by_kind))
        .route("/api/v1/drive/files/stats/name-length-p75-by-kind",           get(file_stats_name_length_p75_by_kind))
        .route("/api/v1/drive/files/stats/name-length-skewness-by-mime",      get(file_stats_name_length_skewness_by_mime))
        ...
        .route("/api/v1/drive/files/stats/name-length-var-by-owner",         get(file_stats_name_length_var_by_owner))
        .route("/api/v1/drive/files/stats/name-length-std-dev-by-owner",     get(file_stats_name_length_std_dev_by_owner))
        .route("/api/v1/drive/files/stats/name-length-iqr-by-owner",         get(file_stats_name_length_iqr_by_owner))
        .route("/api/v1/drive/files/stats/name-length-coeff-var-by-owner",   get(file_stats_name_length_coeff_var_by_owner))
        .route("/api/v1/drive/files/stats/name-length-harmonic-mean-by-owner",  get(file_stats_name_length_harmonic_mean_by_owner))
        ...
        .route("/api/v1/drive/files/stats/name-length-geometric-mean-by-kind", get(file_stats_name_length_geometric_mean_by_kind))
        .route("/api/v1/drive/files/stats/name-length-geometric-mean-by-mime", get(file_stats_name_length_geometric_mean_by_mime))
        .route("/api/v1/drive/files/stats/name-length-geometric-mean-by-ext",  get(file_stats_name_length_geometric_mean_by_ext))
        .route("/api/v1/drive/files/stats/name-length-trimmed-mean-by-kind",   get(file_stats_name_length_trimmed_mean_by_kind))
        .route("/api/v1/drive/files/stats/name-length-trimmed-mean-by-mime",   get(file_stats_name_length_trimmed_mean_by_mime))
        .route("/api/v1/drive/files/stats/name-length-trimmed-mean-by-ext",    get(file_stats_name_length_trimmed_mean_by_ext))
        .route("/api/v1/drive/files/stats/name-length-winsorized-mean-by-kind", get(file_stats_name_length_winsorized_mean_by_kind))
        .route("/api/v1/drive/files/stats/name-length-winsorized-mean-by-mime", get(file_stats_name_length_winsorized_mean_by_mime))
        .route("/api/v1/drive/files/stats/name-length-winsorized-mean-by-ext", get(file_stats_name_length_winsorized_mean_by_ext))
        .route("/api/v1/drive/files/stats/name-length-p05-by-kind",           get(file_stats_name_length_p05_by_kind))
        .route("/api/v1/drive/files/stats/name-length-p05-by-mime",           get(file_stats_name_length_p05_by_mime))
        .route("/api/v1/drive/files/stats/name-length-p05-by-ext",            get(file_stats_name_length_p05_by_ext))
        .route("/api/v1/drive/files/stats/name-length-p10-by-kind",           get(file_stats_name_length_p10_by_kind))
        ...
        .route("/api/v1/drive/files/stats/size-p99-by-mime",                   get(file_stats_size_p99_by_mime))
        ...
        .route("/api/v1/drive/files/stats/name-length-sum-by-mime",            get(file_stats_name_length_sum_by_mime))
        .route("/api/v1/drive/files/stats/name-length-p90-by-mime",            get(file_stats_name_length_p90_by_mime))
        .route("/api/v1/drive/files/stats/name-length-p90-by-ext",             get(file_stats_name_length_p90_by_ext))
        .route("/api/v1/drive/files/stats/name-length-p99-by-kind",            get(file_stats_name_length_p99_by_kind))
        .route("/api/v1/drive/files/stats/name-length-p99-by-mime",            get(file_stats_name_length_p99_by_mime))
        .route("/api/v1/drive/files/stats/size-p05-by-kind",                   get(file_stats_size_p05_by_kind))
        .route("/api/v1/drive/files/stats/size-p05-by-mime",                   get(file_stats_size_p05_by_mime))
        .route("/api/v1/drive/files/stats/size-p05-by-ext",                    get(file_stats_size_p05_by_ext))
        .route("/api/v1/drive/files/stats/size-p10-by-mime",                   get(file_stats_size_p10_by_mime))
...
/// GET /api/v1/drive/files/stats/deletes-by-ext — deleções por extensão de arquivo. Sprint #3829.
async fn file_stats_deletes_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, COUNT(*)::BIGINT AS delete_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NOT NULL AND name LIKE '%.%' \
         GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(ext, cnt)| serde_json::json!({"ext": ext, "delete_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/deletes-by-owner — deleções por proprietário. Sprint #3830.
async fn file_stats_deletes_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, COUNT(*)::BIGINT AS delete_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NOT NULL \
         GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(owner, cnt)| serde_json::json!({"owner_id": owner, "delete_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/uploads-by-owner — uploads por proprietário. Sprint #3831.
async fn file_stats_uploads_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, COUNT(*)::BIGINT AS upload_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(owner, cnt)| serde_json::json!({"owner_id": owner, "upload_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/active-by-kind — arquivos ativos por kind. Sprint #3832.
async fn file_stats_active_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT kind, COUNT(*)::BIGINT AS active_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
...
/// GET /api/v1/drive/files/stats/deleted-by-ext — arquivos deletados por extensão. Sprint #3869.
async fn file_stats_deleted_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, COUNT(*)::BIGINT AS delete_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NOT NULL AND name LIKE '%.%' \
...
/// GET /api/v1/drive/files/stats/deleted-by-owner — arquivos deletados por proprietário. Sprint #3870.
async fn file_stats_deleted_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, COUNT(*)::BIGINT AS delete_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NOT NULL \
...
/// GET /api/v1/drive/files/stats/active-count-total — total de arquivos ativos no tenant. Sprint #3871.
async fn file_stats_active_count_total(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let row: (i64,) = sqlx::query_as(
        "SELECT COUNT(*)::BIGINT AS active_count FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL",
    ).bind(ctx.tenant_id).fetch_one(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    Ok(Json(serde_json::json!({"active_count": row.0})))
}

/// GET /api/v1/drive/files/stats/deleted-count-total — total de arquivos deletados no tenant. Sprint #3872.
async fn file_stats_deleted_count_total(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let row: (i64,) = sqlx::query_as(
        "SELECT COUNT(*)::BIGINT AS deleted_count FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NOT NULL",
    ).bind(ctx.tenant_id).fetch_one(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    Ok(Json(serde_json::json!({"deleted_count": row.0})))
}

/// GET /api/v1/drive/files/stats/size-total-active — soma total de bytes de arquivos ativos. Sprint #3889.
async fn file_stats_size_total_active(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let row: (Option<i64>,) = sqlx::query_as(
        "SELECT SUM(size_bytes)::BIGINT AS total_size FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL",
    ).bind(ctx.tenant_id).fetch_one(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    Ok(Json(serde_json::json!({"total_active_size_bytes": row.0.unwrap_or(0)})))
}

/// GET /api/v1/drive/files/stats/size-total-deleted — soma total de bytes de arquivos deletados. Sprint #3890.
async fn file_stats_size_total_deleted(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let row: (Option<i64>,) = sqlx::query_as(
        "SELECT SUM(size_bytes)::BIGINT AS total_size FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NOT NULL",
    ).bind(ctx.tenant_id).fetch_one(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    Ok(Json(serde_json::json!({"total_deleted_size_bytes": row.0.unwrap_or(0)})))
}

/// GET /api/v1/drive/files/stats/total-size-by-mime — tamanho total por tipo MIME. Sprint #3891.
async fn file_stats_total_size_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<i64>, i64)> = sqlx::query_as(
        "SELECT mime_type, SUM(size_bytes)::BIGINT AS total_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(mime, size, cnt)| serde_json::json!({"mime_type": mime, "total_size_bytes": size.unwrap_or(0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/avg-size-by-kind — tamanho médio por kind. Sprint #3892.
async fn file_stats_avg_size_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, AVG(size_bytes)::FLOAT8 AS avg_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
...
/// GET /api/v1/drive/files/stats/min-size-by-kind — tamanho mínimo por kind. Sprint #3949.
async fn file_stats_min_size_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<i64>, i64)> = sqlx::query_as(
        "SELECT kind, MIN(size_bytes)::BIGINT AS min_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(kind, min, cnt)| serde_json::json!({"kind": kind, "min_size_bytes": min.unwrap_or(0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/min-size-by-mime — tamanho mínimo por tipo MIME. Sprint #3950.
async fn file_stats_min_size_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<i64>, i64)> = sqlx::query_as(
        "SELECT mime_type, MIN(size_bytes)::BIGINT AS min_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(mime, min, cnt)| serde_json::json!({"mime_type": mime, "min_size_bytes": min.unwrap_or(0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/min-size-by-ext — tamanho mínimo por extensão. Sprint #3951.
async fn file_stats_min_size_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<i64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, MIN(size_bytes)::BIGINT AS min_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' \
         GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(ext, min, cnt)| serde_json::json!({"ext": ext, "min_size_bytes": min.unwrap_or(0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/min-size-by-owner — tamanho mínimo por proprietário. Sprint #3952.
async fn file_stats_min_size_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<i64>, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, MIN(size_bytes)::BIGINT AS min_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(owner, min, cnt)| serde_json::json!({"owner_id": owner, "min_size_bytes": min.unwrap_or(0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/std-dev-size-by-kind — desvio padrão de tamanho por kind. Sprint #3969.
async fn file_stats_std_dev_size_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, STDDEV_POP(size_bytes)::FLOAT8 AS std_dev_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(kind, std_dev, cnt)| serde_json::json!({"kind": kind, "std_dev_size_bytes": std_dev.unwrap_or(0.0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/std-dev-size-by-mime — desvio padrão de tamanho por tipo MIME. Sprint #3970.
async fn file_stats_std_dev_size_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, STDDEV_POP(size_bytes)::FLOAT8 AS std_dev_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(mime, std_dev, cnt)| serde_json::json!({"mime_type": mime, "std_dev_size_bytes": std_dev.unwrap_or(0.0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/std-dev-size-by-ext — desvio padrão de tamanho por extensão. Sprint #3971.
async fn file_stats_std_dev_size_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, STDDEV_POP(size_bytes)::FLOAT8 AS std_dev_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' \
         GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(ext, std_dev, cnt)| serde_json::json!({"ext": ext, "std_dev_size_bytes": std_dev.unwrap_or(0.0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/std-dev-size-by-owner — desvio padrão de tamanho por proprietário. Sprint #3972.
async fn file_stats_std_dev_size_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, STDDEV_POP(size_bytes)::FLOAT8 AS std_dev_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files \
         WHERE tenant_id = $1 AND deleted_at IS NULL \
         GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result: Vec<serde_json::Value> = rows.into_iter()
        .map(|(owner, std_dev, cnt)| serde_json::json!({"owner_id": owner, "std_dev_size_bytes": std_dev.unwrap_or(0.0), "file_count": cnt}))
        .collect();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-skewness-by-kind — skewness de comprimento de nome por kind. Sprint #4029.
async fn file_stats_name_length_skewness_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT kind, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, raw, cnt)| {
        let vals: Vec<f64> = raw.into_iter().flatten().map(|v| v as f64).collect();
        let n = vals.len();
        let skewness = if n < 3 { 0.0 } else {
            let mean = vals.iter().sum::<f64>() / n as f64;
        ...
        serde_json::json!({"kind": kind, "skewness_name_length": skewness, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-kurtosis-by-kind — kurtosis de comprimento de nome por kind. Sprint #4030.
async fn file_stats_name_length_kurtosis_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT kind, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, raw, cnt)| {
        ...
        serde_json::json!({"kind": kind, "kurtosis_name_length": kurtosis, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p25-by-kind — P25 de comprimento de nome por kind. Sprint #4031.
async fn file_stats_name_length_p25_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, PERCENTILE_CONT(0.25) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p25_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p25, cnt)| serde_json::json!({"kind": kind, "p25_name_length": p25.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p75-by-kind — P75 de comprimento de nome por kind. Sprint #4032.
async fn file_stats_name_length_p75_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p75_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p75, cnt)| serde_json::json!({"kind": kind, "p75_name_length": p75.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-skewness-by-mime — skewness de comprimento de nome por MIME. Sprint #4049.
async fn file_stats_name_length_skewness_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT mime_type, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, raw, cnt)| {
        let vals: Vec<f64> = raw.into_iter().flatten().map(|v| v as f64).collect();
        let n = vals.len();
        let skewness = if n < 3 { 0.0 } else {
            let mean = vals.iter().sum::<f64>() / n as f64;
        ...
        serde_json::json!({"mime_type": mime, "skewness_name_length": skewness, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-kurtosis-by-mime — kurtosis de comprimento de nome por MIME. Sprint #4050.
async fn file_stats_name_length_kurtosis_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT mime_type, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, raw, cnt)| {
        ...
        serde_json::json!({"mime_type": mime, "kurtosis_name_length": kurtosis, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p25-by-mime — P25 de comprimento de nome por MIME. Sprint #4051.
async fn file_stats_name_length_p25_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, PERCENTILE_CONT(0.25) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p25_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, p25, cnt)| serde_json::json!({"mime_type": mime, "p25_name_length": p25.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p75-by-mime — P75 de comprimento de nome por MIME. Sprint #4052.
async fn file_stats_name_length_p75_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p75_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
...
/// GET /api/v1/drive/files/stats/name-length-var-by-owner — variância de comprimento de nome por owner. Sprint #4109.
async fn file_stats_name_length_var_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id, VAR_POP(LENGTH(name))::FLOAT8 AS var_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, var, cnt)| serde_json::json!({"owner_id": owner, "var_name_length": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-std-dev-by-owner — desvio padrão de comprimento de nome por owner. Sprint #4110.
async fn file_stats_name_length_std_dev_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id, STDDEV_POP(LENGTH(name))::FLOAT8 AS std_dev_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, std, cnt)| serde_json::json!({"owner_id": owner, "std_dev_name_length": std.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-iqr-by-owner — IQR de comprimento de nome por owner. Sprint #4111.
async fn file_stats_name_length_iqr_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, f64, f64, i64)> = sqlx::query_as(
        "SELECT owner_id, \
    ...
    let result = rows.into_iter().map(|(owner, p25, p75, cnt)| serde_json::json!({"owner_id": owner, "iqr_name_length": p75 - p25, "p25_name_length": p25, "p75_name_length": p75, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-coeff-var-by-owner — coeficiente de variação de comprimento de nome por owner. Sprint #4112.
async fn file_stats_name_length_coeff_var_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Option<f64>, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id, \
                STDDEV_POP(LENGTH(name))::FLOAT8 AS std_dev_name_len, \
                AVG(LENGTH(name))::FLOAT8 AS mean_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, std, mean, cnt)| {
        let cv = match (std, mean) {
            (Some(s), Some(m)) if m != 0.0 => Some(s / m),
            _ => None,
        };
        serde_json::json!({"owner_id": owner, "coeff_var_name_length": cv, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-harmonic-mean-by-owner — média harmônica de comprimento de nome por owner. Sprint #4129.
async fn file_stats_name_length_harmonic_mean_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id, \
    ...
    let result = rows.into_iter().map(|(owner, hm, cnt)| serde_json::json!({"owner_id": owner, "harmonic_mean_name_length": hm, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-geometric-mean-by-owner — média geométrica de comprimento de nome por owner. Sprint #4130.
async fn file_stats_name_length_geometric_mean_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id, EXP(AVG(LN(NULLIF(LENGTH(name), 0))))::FLOAT8 AS geometric_mean_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, gm, cnt)| serde_json::json!({"owner_id": owner, "geometric_mean_name_length": gm, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-trimmed-mean-by-owner — média aparada P10–P90 de comprimento de nome por owner. Sprint #4131.
async fn file_stats_name_length_trimmed_mean_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT owner_id, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, raw, cnt)| {
        ...
        let mean = if n == 0 { None } else {
            ...
            if trimmed.is_empty() { None } else { Some(trimmed.iter().sum::<f64>() / trimmed.len() as f64) }
        };
        serde_json::json!({"owner_id": owner, "trimmed_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-winsorized-mean-by-owner — média winsorizada P10–P90 de comprimento de nome por owner. Sprint #4132.
async fn file_stats_name_length_winsorized_mean_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(uuid::Uuid, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT owner_id, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, raw, cnt)| {
        ...
        let mean = if n == 0 { None } else {
            ...
            for v in vals.iter_mut() { if *v < lo_val { *v = lo_val; } if *v > hi_val { *v = hi_val; } }
            Some(vals.iter().sum::<f64>() / n as f64)
        };
...
/// GET /api/v1/drive/files/stats/name-length-var-by-kind — variância de comprimento de nome por kind. Sprint #4009.
async fn file_stats_name_length_var_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, VAR_POP(LENGTH(name))::FLOAT8 AS variance_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, var, cnt)| serde_json::json!({"kind": kind, "variance_name_length": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-var-by-mime — variância de comprimento de nome por tipo MIME. Sprint #4010.
async fn file_stats_name_length_var_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, VAR_POP(LENGTH(name))::FLOAT8 AS variance_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, var, cnt)| serde_json::json!({"mime_type": mime, "variance_name_length": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-var-by-ext — variância de comprimento de nome por extensão. Sprint #4011.
async fn file_stats_name_length_var_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, VAR_POP(LENGTH(name))::FLOAT8 AS variance_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, var, cnt)| serde_json::json!({"ext": ext, "variance_name_length": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-var-by-owner — variância de comprimento de nome por proprietário. Sprint #4012.
async fn file_stats_name_length_var_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, VAR_POP(LENGTH(name))::FLOAT8 AS variance_name_len, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(owner, var, cnt)| serde_json::json!({"owner_id": owner, "variance_name_length": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/var-size-by-kind — variância de tamanho por kind. Sprint #3989.
async fn file_stats_var_size_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, VAR_POP(size_bytes)::FLOAT8 AS variance_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, var, cnt)| serde_json::json!({"kind": kind, "variance_size_bytes": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/var-size-by-mime — variância de tamanho por tipo MIME. Sprint #3990.
async fn file_stats_var_size_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, VAR_POP(size_bytes)::FLOAT8 AS variance_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, var, cnt)| serde_json::json!({"mime_type": mime, "variance_size_bytes": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/var-size-by-ext — variância de tamanho por extensão. Sprint #3991.
async fn file_stats_var_size_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, VAR_POP(size_bytes)::FLOAT8 AS variance_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, var, cnt)| serde_json::json!({"ext": ext, "variance_size_bytes": var.unwrap_or(0.0), "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/var-size-by-owner — variância de tamanho por proprietário. Sprint #3992.
async fn file_stats_var_size_by_owner(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT owner_id::TEXT AS owner_id, VAR_POP(size_bytes)::FLOAT8 AS variance_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY owner_id ORDER BY owner_id",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
...
/// GET /api/v1/drive/files/stats/name-length-p10-by-kind — P10 de comprimento de nome por kind. Sprint #4269.
async fn file_stats_name_length_p10_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT kind, \
                PERCENTILE_CONT(0.10) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p10_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p10, cnt)| serde_json::json!({"kind": kind, "p10_name_length": p10, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p10-by-mime — P10 de comprimento de nome por tipo MIME. Sprint #4270.
async fn file_stats_name_length_p10_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                PERCENTILE_CONT(0.10) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p10_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, p10, cnt)| serde_json::json!({"mime_type": mime, "p10_name_length": p10, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p10-by-ext — P10 de comprimento de nome por extensão. Sprint #4271.
async fn file_stats_name_length_p10_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, \
                PERCENTILE_CONT(0.10) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p10_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(ext, p10, cnt)| serde_json::json!({"ext": ext, "p10_name_length": p10, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p90-by-kind — P90 de comprimento de nome por kind. Sprint #4272.
async fn file_stats_name_length_p90_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT kind, \
                PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p90_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p90, cnt)| serde_json::json!({"kind": kind, "p90_name_length": p90, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-winsorized-mean-by-ext — média winsorized (10–90%) de comprimento de nome por extensão. Sprint #4249.
async fn file_stats_name_length_winsorized_mean_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, lens, cnt)| {
        let mut vals: Vec<i32> = lens.into_iter().flatten().collect();
        vals.sort_unstable();
        let n = vals.len();
        let mean = if n > 0 {
            ...
            let hi_val = vals[hi_idx];
            let wsum: i32 = vals.iter().map(|&v| v.clamp(lo_val, hi_val)).sum();
            Some(wsum as f64 / n as f64)
        } else { None };
        serde_json::json!({"ext": ext, "winsorized_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p05-by-kind — P05 de comprimento de nome por kind. Sprint #4250.
async fn file_stats_name_length_p05_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT kind, \
                PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p05_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p05, cnt)| serde_json::json!({"kind": kind, "p05_name_length": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p05-by-mime — P05 de comprimento de nome por tipo MIME. Sprint #4251.
async fn file_stats_name_length_p05_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p05_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, p05, cnt)| serde_json::json!({"mime_type": mime, "p05_name_length": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p05-by-ext — P05 de comprimento de nome por extensão. Sprint #4252.
async fn file_stats_name_length_p05_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, \
                PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p05_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(ext, p05, cnt)| serde_json::json!({"ext": ext, "p05_name_length": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-trimmed-mean-by-mime — média trimmed (10–90%) de comprimento de nome por tipo MIME. Sprint #4229.
async fn file_stats_name_length_trimmed_mean_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT mime_type, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, lens, cnt)| {
        let vals: Vec<i32> = lens.into_iter().flatten().collect();
        let n = vals.len();
        let mean = if n > 0 {
            let lo = (n as f64 * 0.10).ceil() as usize;
            let hi = (n as f64 * 0.90).floor() as usize;
            let trimmed = if lo < hi { &vals[lo..hi] } else { &vals[..] };
            Some(trimmed.iter().sum::<i32>() as f64 / trimmed.len() as f64)
        } else { None };
        serde_json::json!({"mime_type": mime, "trimmed_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-trimmed-mean-by-ext — média trimmed (10–90%) de comprimento de nome por extensão. Sprint #4230.
async fn file_stats_name_length_trimmed_mean_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, lens, cnt)| {
        ...
        serde_json::json!({"ext": ext, "trimmed_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-winsorized-mean-by-kind — média winsorized (10–90%) de comprimento de nome por kind. Sprint #4231.
async fn file_stats_name_length_winsorized_mean_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT kind, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, lens, cnt)| {
        let mut vals: Vec<i32> = lens.into_iter().flatten().collect();
        vals.sort_unstable();
        let n = vals.len();
        let mean = if n > 0 {
        ...
        serde_json::json!({"kind": kind, "winsorized_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-winsorized-mean-by-mime — média winsorized (10–90%) de comprimento de nome por tipo MIME. Sprint #4232.
async fn file_stats_name_length_winsorized_mean_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT mime_type, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, lens, cnt)| {
        ...
        serde_json::json!({"mime_type": mime, "winsorized_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-geometric-mean-by-kind — média geométrica de comprimento de nome por kind. Sprint #4209.
async fn file_stats_name_length_geometric_mean_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT kind, \
                EXP(AVG(LN(NULLIF(LENGTH(name), 0))))::FLOAT8 AS geometric_mean_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, gm, cnt)| serde_json::json!({"kind": kind, "geometric_mean_name_length": gm, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-geometric-mean-by-mime — média geométrica de comprimento de nome por tipo MIME. Sprint #4210.
async fn file_stats_name_length_geometric_mean_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                EXP(AVG(LN(NULLIF(LENGTH(name), 0))))::FLOAT8 AS geometric_mean_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, gm, cnt)| serde_json::json!({"mime_type": mime, "geometric_mean_name_length": gm, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-geometric-mean-by-ext — média geométrica de comprimento de nome por extensão. Sprint #4211.
async fn file_stats_name_length_geometric_mean_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, \
                EXP(AVG(LN(NULLIF(LENGTH(name), 0))))::FLOAT8 AS geometric_mean_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(ext, gm, cnt)| serde_json::json!({"ext": ext, "geometric_mean_name_length": gm, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-trimmed-mean-by-kind — média trimmed (10–90%) de comprimento de nome por kind. Sprint #4212.
async fn file_stats_name_length_trimmed_mean_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Vec<Option<i32>>, i64)> = sqlx::query_as(
        "SELECT kind, ARRAY_AGG(LENGTH(name) ORDER BY LENGTH(name)) AS lens, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, lens, cnt)| {
        ...
        serde_json::json!({"kind": kind, "trimmed_mean_name_length": mean, "file_count": cnt})
    }).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}
...
/// GET /api/v1/drive/files/stats/size-var-by-mime — variância de tamanho de arquivo por MIME. Sprint #4369.
async fn file_stats_size_var_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT mime_type, VAR_POP(size)::FLOAT8 AS var_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, var, cnt)| serde_json::json!({"mime_type": mime, "var_size_bytes": var, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-var-by-ext — variância de tamanho de arquivo por extensão. Sprint #4370.
async fn file_stats_size_var_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, Option<f64>, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, VAR_POP(size)::FLOAT8 AS var_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, var, cnt)| serde_json::json!({"ext": ext, "var_size_bytes": var, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-sum-by-ext — soma de tamanho de arquivo por extensão. Sprint #4371.
async fn file_stats_size_sum_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, SUM(size)::BIGINT AS sum_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, sum, cnt)| serde_json::json!({"ext": ext, "sum_size_bytes": sum, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-p99-by-mime — P99 de tamanho de arquivo por MIME. Sprint #4372.
async fn file_stats_size_p99_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, PERCENTILE_CONT(0.99) WITHIN GROUP (ORDER BY size)::FLOAT8 AS p99_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, p99, cnt)| serde_json::json!({"mime_type": mime, "p99_size_bytes": p99, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}
...
/// GET /api/v1/drive/files/stats/name-length-p99-by-ext — P99 de comprimento de nome por extensão. Sprint #4309.
async fn file_stats_name_length_p99_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, \
                PERCENTILE_CONT(0.99) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p99_name_len, \
                COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, p99, cnt)| serde_json::json!({"ext": ext, "p99_name_length": p99, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-max-by-kind — máximo de comprimento de nome por kind. Sprint #4310.
async fn file_stats_name_length_max_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64, i64)> = sqlx::query_as(
        "SELECT kind, \
                MAX(LENGTH(name))::BIGINT AS max_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(kind, mx, cnt)| serde_json::json!({"kind": kind, "max_name_length": mx, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-sum-by-kind — soma de comprimento de nome por kind. Sprint #4311.
async fn file_stats_name_length_sum_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64, i64)> = sqlx::query_as(
        "SELECT kind, \
                SUM(LENGTH(name))::BIGINT AS sum_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(kind, sum, cnt)| serde_json::json!({"kind": kind, "sum_name_length": sum, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-sum-by-mime — soma de comprimento de nome por MIME. Sprint #4312.
async fn file_stats_name_length_sum_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, i64, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                SUM(LENGTH(name))::BIGINT AS sum_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, sum, cnt)| serde_json::json!({"mime_type": mime, "sum_name_length": sum, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p90-by-mime — P90 de comprimento de nome por MIME. Sprint #4289.
async fn file_stats_name_length_p90_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p90_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, p90, cnt)| serde_json::json!({"mime_type": mime, "p90_name_length": p90, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p90-by-ext — P90 de comprimento de nome por extensão. Sprint #4290.
async fn file_stats_name_length_p90_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, \
                PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p90_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(ext, p90, cnt)| serde_json::json!({"ext": ext, "p90_name_length": p90, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p99-by-kind — P99 de comprimento de nome por kind. Sprint #4291.
async fn file_stats_name_length_p99_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT kind, \
                PERCENTILE_CONT(0.99) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p99_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(kind, p99, cnt)| serde_json::json!({"kind": kind, "p99_name_length": p99, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/name-length-p99-by-mime — P99 de comprimento de nome por MIME. Sprint #4292.
async fn file_stats_name_length_p99_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, \
                PERCENTILE_CONT(0.99) WITHIN GROUP (ORDER BY LENGTH(name))::FLOAT8 AS p99_name_len, \
                COUNT(*)::BIGINT AS file_count \
    ...
    let result = rows.into_iter().map(|(mime, p99, cnt)| serde_json::json!({"mime_type": mime, "p99_name_length": p99, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-p05-by-kind — P05 de tamanho de arquivo por kind. Sprint #4409.
async fn file_stats_size_p05_by_kind(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT kind, PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY size)::FLOAT8 AS p05_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY kind ORDER BY kind",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(kind, p05, cnt)| serde_json::json!({"kind": kind, "p05_size_bytes": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-p05-by-mime — P05 de tamanho de arquivo por MIME. Sprint #4410.
async fn file_stats_size_p05_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY size)::FLOAT8 AS p05_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, p05, cnt)| serde_json::json!({"mime_type": mime, "p05_size_bytes": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-p05-by-ext — P05 de tamanho de arquivo por extensão. Sprint #4411.
async fn file_stats_size_p05_by_ext(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT LOWER(REGEXP_REPLACE(name, '^.*\\.', '')) AS ext, PERCENTILE_CONT(0.05) WITHIN GROUP (ORDER BY size)::FLOAT8 AS p05_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL AND name LIKE '%.%' GROUP BY ext ORDER BY ext",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(ext, p05, cnt)| serde_json::json!({"ext": ext, "p05_size_bytes": p05, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}

/// GET /api/v1/drive/files/stats/size-p10-by-mime — P10 de tamanho de arquivo por MIME. Sprint #4412.
async fn file_stats_size_p10_by_mime(State(state): State<AppState>, ctx: RequestCtx) -> Result<Json<serde_json::Value>> {
    let rows: Vec<(String, f64, i64)> = sqlx::query_as(
        "SELECT mime_type, PERCENTILE_CONT(0.10) WITHIN GROUP (ORDER BY size)::FLOAT8 AS p10_size, COUNT(*)::BIGINT AS file_count \
         FROM drive_files WHERE tenant_id = $1 AND deleted_at IS NULL GROUP BY mime_type ORDER BY mime_type",
    ).bind(ctx.tenant_id).fetch_all(state.db_or_unavailable()?).await.map_err(db_or_unavailable)?;
    let result = rows.into_iter().map(|(mime, p10, cnt)| serde_json::json!({"mime_type": mime, "p10_size_bytes": p10, "file_count": cnt})).collect::<Vec<_>>();
    Ok(Json(serde_json::json!({"rows": result})))
}
