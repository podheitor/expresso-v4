...
pub fn sign_token(secret: &[u8], file_id: &str, tenant: &str, user: &str, ttl_secs: i64) -> String {
...
pub fn build_iframe_url(
    ...
    format!(
        ...
        collabora_base.trim_end_matches('/'),
        enc_src,
        enc_tok,
    )
}
